...
@router.get("/content/project/{project_id}", summary="获取项目的所有内容", response_model=List[NovelContent])
...
@router.get("/content/chapter/{project_id}/{chapter}", summary="获取指定章节的内容", response_model=List[NovelContent])
...
@router.get("/content/line/{project_id}/{chapter}/{line}", summary="获取指定行的内容", response_model=NovelContent)
...
@router.get("/content/range/{project_id}/{chapter}", summary="获取行范围的内容", response_model=List[NovelContent])
...
@router.get("/content/count/{project_id}", summary="获取项目的内容总数")
...
@router.get("/content/chapters/count/{project_id}", summary="获取项目的章节总数")
...
@router.delete("/content/project/{project_id}", summary="删除项目的所有内容")
...
@router.delete("/content/chapter/{project_id}/{chapter}", summary="删除指定章节的内容")
