...
class NovelParser:
    ...
    @classmethod
    def parse_file(cls, file_path: Path, project_id: str) -> list[NovelContent]:
        """
        ...
        try:
            ...
            # 解析文本
            return cls.parse_text(content, project_id)
    ...
    @classmethod
    def parse_text(cls, text: str, project_id: str) -> list[NovelContent]:
        """
