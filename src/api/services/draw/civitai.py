...
class CivitaiDrawService(AbstractDrawService):
    ...
    # Civitai 允许的值: EulerA, Euler, LMS, Heun, DPM2, DPM2A, DPM2SA, DPM2M, DPMSDE, 
    # DPMFast, DPMAdaptive, LMSKarras, DPM2Karras, DPM2AKarras, DPM2SAKarras, DPM2MKarras, 
    # DPMSDEKarras, DDIM, PLMS, UniPC, Undefined, LCM, DDPM, DEIS
    SCHEDULER_MAP = {
        "Euler a": "EulerA",
        "Euler": "Euler",
    ...
    def draw(self, args: DrawArgs, name: Optional[str] = None, desc: Optional[str] = None) -> str:
        """
        创建单个绘图任务并启动监控。
