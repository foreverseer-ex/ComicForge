    ...
    >
      ...
      >
        ...
        >
          ...
          <!-- 复选框选项（如果提供了 checkboxLabel） -->
          <div v-if="checkboxLabel" class="mt-4 flex items-center">
            <input
              type="checkbox"
              :id="`confirm-checkbox-${_uid}`"
...
interface Props {
  ...
  checkboxDefaultValue?: boolean  // 复选框默认值
}
...
const emit = defineEmits<{
  (e: 'confirm', checkboxValue?: boolean): void
  (e: 'cancel'): void
}>()
...
const checkboxValue = ref(props.checkboxDefaultValue)
